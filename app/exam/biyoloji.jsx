...
import biologyExamQuestions from '../../data/exam/biyoloji';
...
export default function Biology({ navigation }) {
  ...
  const currentQuestion = biologyExamQuestions [currentIndex];
  ...
  const handleNext = () => {
    if (currentIndex + 1 <  biologyExamQuestions.length) {
  ...
  if (showResult) {
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.score}>Skor: {score} / { biologyExamQuestions.length}</Text>
      </View>
    );
  }
