...
import mathExamQuestions from '../../data/exam/math';
...
export default function Math({ navigation }) {
  ...
  const currentQuestion = mathExamQuestions[currentIndex];
  ...
  const handleNext = () => {
    if (currentIndex + 1 < mathExamQuestions.length) {
  ...
  if (showResult) {
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.score}>Skor: {score} / {mathExamQuestions.length}</Text>
      </View>
    );
  }
