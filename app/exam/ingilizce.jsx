...
import englishExamQuestions from '../../data/exam/ingilizce';
...
export default function English({ navigation }) {
  ...
  const currentQuestion = englishExamQuestions[currentIndex];
  ...
  const handleNext = () => {
    if (currentIndex + 1 <englishExamQuestions.length) {
  ...
  if (showResult) {
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.score}>Skor: {score} / {englishExamQuestions.length}</Text>
      </View>
    );
  }
