...
export default function Math() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      {/* Dersler */}
      <TouchableOpacity style={styles.sectionCard} onPress={() => router.push('/(routers)/pages/History.Screen')}>
      ...
      {/* Videolar */}
      <TouchableOpacity style={styles.sectionCard} onPress={() => router.push('/videos/history')}>
        <Text style={styles.emoji}>🎥</Text>
      ...
      {/* Quizler */}
      <TouchableOpacity style={styles.sectionCard} onPress={() => router.push('/quiz/tarih')}>
        <Text style={styles.emoji}>🧠</Text>
      ...
      {/* Sınavlar */}
      <TouchableOpacity style={styles.sectionCard} onPress={() => router.push('/exam/tarih')}>
        <Text style={styles.emoji}>📝</Text>
