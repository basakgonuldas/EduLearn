...
export default function Math() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.header}>📘 Mathematics</Text>

      {/* Dersler */}
      <TouchableOpacity style={styles.sectionCard} onPress={() => router.push('/(routers)/pages/Math.Screen')}>
      ...
      {/* Videolar */}
      <TouchableOpacity style={styles.sectionCard} onPress={() => router.push('/videos/math')}>
        <Text style={styles.emoji}>🎥</Text>
      ...
      {/* Quizler */}
      <TouchableOpacity style={styles.sectionCard} onPress={() => router.push('/quiz/math')}>
        <Text style={styles.emoji}>🧠</Text>
      ...
      {/* Sınavlar */}
      <TouchableOpacity style={styles.sectionCard} onPress={() => router.push('/exam/math')}>
        <Text style={styles.emoji}>📝</Text>
