...
export default function Math() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      {/* Dersler */}
      <TouchableOpacity style={styles.sectionCard} onPress={() => router.push('/(routers)/pages/Biology.Screen')}>
      ...
      {/* Videolar */}
      <TouchableOpacity style={styles.sectionCard} onPress={() => router.push('/videos/biology')}>
        <Text style={styles.emoji}>🎥</Text>
      ...
      {/* Quizler */}
      <TouchableOpacity style={styles.sectionCard} onPress={() => router.push('/quiz/biyoloji')}>
        <Text style={styles.emoji}>🧠</Text>
      ...
      {/* Sınavlar */}
      <TouchableOpacity style={styles.sectionCard} onPress={() => router.push('/exam/biyoloji')}>
        <Text style={styles.emoji}>📝</Text>
