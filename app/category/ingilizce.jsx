...
export default function Math() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      {/* Dersler */}
      <TouchableOpacity style={styles.sectionCard} onPress={() => router.push('/(routers)/pages/English.Screen')}>
      ...
      {/* Videolar */}
      <TouchableOpacity style={styles.sectionCard} onPress={() => router.push('/videos/english')}>
        <Text style={styles.emoji}>🎥</Text>
      ...
      {/* Quizler */}
      <TouchableOpacity style={styles.sectionCard} onPress={() => router.push('/quiz/ingilizce')}>
        <Text style={styles.emoji}>🧠</Text>
      ...
      {/* Sınavlar */}
      <TouchableOpacity style={styles.sectionCard} onPress={() => router.push('/exam/ingilizce')}>
        <Text style={styles.emoji}>📝</Text>
