...
export default function Math() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.header}>📘Geography</Text>

      {/* Dersler */}
      <TouchableOpacity style={styles.sectionCard} onPress={() => router.push('/(routers)/pages/Geo.Screen')}>
      ...
      {/* Videolar */}
      <TouchableOpacity style={styles.sectionCard} onPress={() => router.push('/videos/geography')}>
        <Text style={styles.emoji}>🎥</Text>
      ...
      {/* Quizler */}
      <TouchableOpacity style={styles.sectionCard} onPress={() => router.push('/quiz/cografya')}>
        <Text style={styles.emoji}>🧠</Text>
      ...
      {/* Sınavlar */}
      <TouchableOpacity style={styles.sectionCard} onPress={() => router.push('/exam/cografya')}>
        <Text style={styles.emoji}>📝</Text>
