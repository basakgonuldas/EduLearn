...
import mathQuestions from '../../data/quiz/mathdata';
...
const MathApp = () => {
  ...
  if (currentIndex >= mathQuestions.length) {
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.scoreText}>Puanın: {score} / {mathQuestions.length}</Text>
  ...
  const { question, answer } = mathQuestions[currentIndex];

  return (
    <View style={styles.container}>
      <Text style={styles.title}>🧠 Matematik Flashcard Oyunu</Text>
      <Text style={styles.progressText}>Soru {currentIndex + 1} / {mathQuestions.length}</Text>
