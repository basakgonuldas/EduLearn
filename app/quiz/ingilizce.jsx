...
import ingilizceQuestions from '../../data/quiz/ingilizcedata';
...
const EngApp = () => {
  ...
  if (currentIndex >= ingilizceQuestions.length) {
    return (
      <View style={styles.container}>
        <Text style={styles.title}>🎉 Oyun Bitti!</Text>
        <Text style={styles.scoreText}>Puanın: {score} / {ingilizceQuestions.length}</Text>
  ...
  const { question, answer } = ingilizceQuestions[currentIndex];

  return (
    <View style={styles.container}>
      <Text style={styles.title}>🧠 İngilizce Flashcard Oyunu</Text>
      <Text style={styles.progressText}>Soru {currentIndex + 1} / {ingilizceQuestions.length}</Text>
