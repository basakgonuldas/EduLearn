...
import kimyaQuestions from '../../data/quiz/kimyadata';
...
const ChemicalApp = () => {
  ...
  if (currentIndex >= kimyaQuestions.length) {
    return (
      <View style={styles.container}>
        <Text style={styles.title}>🎉 Oyun Bitti!</Text>
        <Text style={styles.scoreText}>Puanın: {score} / {kimyaQuestions.length}</Text>
  ...
  const { question, answer } = kimyaQuestions[currentIndex];

  return (
    <View style={styles.container}>
      <Text style={styles.title}>🧠 Kimya Flashcard Oyunu</Text>
      <Text style={styles.progressText}>Soru {currentIndex + 1} / {kimyaQuestions.length}</Text>
